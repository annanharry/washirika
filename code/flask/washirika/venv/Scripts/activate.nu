...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\Xampp\htdocs\washirika-1\code\flask\washirika\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\Xampp\htdocs\washirika-1\code\flask\washirika\venv\Scripts\deactivate.nu'
